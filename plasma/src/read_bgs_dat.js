define(function(require, exports, module){
	...
	xhr.open("GET", "../plasma/src/data/truncated_bgs.dat", true);
	...
	var setupEngine = exports.setupEngine = function setupEngine(){
		...
		//console.log(layer1.getDistorter());
		...
		//var ebCanvas = document.createElement("canvas");
		//ebCanvas.id = "ebCanvas";
		var ebCanvas = document.getElementById("ebCanvas");
		
		Engine.start(layer1, layer2, fps, aspectRatio, frameskip, alpha, ebCanvas);
		Engine.updating = 1;
		Engine.rom = Rom;
		Engine.setLayer1 = function(val){
			this.layer1 = new BackgroundLayer.BackgroundLayer(this.rom, val);
			this.distorter1 = this.layer1.getDistorter();
			this.effect1 = this.distorter1.getEffect();
		}.bind(Engine);
		Engine.setLayer2 = function(val){
			this.layer2 = new BackgroundLayer.BackgroundLayer(this.rom, val);
			this.distorter2 = this.layer2.getDistorter();
